...
export const COMMANDS: CommandDef[] = [
  ...
  { code: "ALT", label: "Agriculture intelligence", description: "Satellite · weather · rainfall · yield · trade", keywords: ["alt", "alternative", "agriculture", "weather", "rainfall", "satellite", "yield", "production", "trade", "country"] },
...
const NL_HINTS: Array<{ match: RegExp; code: string }> = [
  ...
  { match: /\b(alt|alternative|agriculture|weather|rainfall|drought|satellite|yield|production|trade|country|dataset)\b/i, code: "ALT" },
