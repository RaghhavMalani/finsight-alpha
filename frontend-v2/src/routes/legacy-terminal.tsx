...
export const Route = createFileRoute("/legacy-terminal")({
  head: () => ({
    meta: [
      { title: "Legacy Terminal — FinSight" },
      {
        name: "description",
        content: "The pre-Forge FinSight research desk, preserved as a legacy surface.",
      },
