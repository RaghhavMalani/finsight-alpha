"""Verify the frozen Dynamics D0.3.1 identifiability artifact."""
...
def main() -> None:
    ...
    parser.add_argument("--artifact", type=Path, default=DEFAULT_D031_ARTIFACT)
    ...
    report = {
        ...
        **verify_identifiability_artifact(artifact),
    }
