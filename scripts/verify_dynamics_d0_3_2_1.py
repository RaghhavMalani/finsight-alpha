"""Verify the frozen Dynamics D0.3.2.1 failure-decomposition artifact."""
...
def main() -> None:
    ...
    parser.add_argument("--artifact", type=Path, default=DEFAULT_D0321_ARTIFACT)
    ...
    report = {
        ...
        **verify_failure_decomposition(artifact),
    }
